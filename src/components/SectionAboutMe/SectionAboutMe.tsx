        ...
        <div className="max-w-4xl mx-auto p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <div className="text-center md:text-right">
              <div className={`${styles.cardContainerBorder} relative w-full h-80 md:w-80 md:h-80`}>
                <Image
            ...
            <div className="text-center md:text-left w-auto">
              <h4 className={`text-lg md:text-1xl font-bold ${styles.animateColorChange}`}>
                {!isLargeScreen && welcome + '. '}{aboutText}
              </h4>
            </div>
          </div>
        </div>
